package edu.iua.nexus.auth.events;
...
//esto usa una clase base applicationListener que escucha eventos (yo elijo cuales) que se PUBLICAN
//o sea yo para hacer un login podría hacer eventPublisher.publishEvent(new UserEvent(this, UserEvent.TypeEvent.LOGIN, user));
	@Override
	...
	private void handleLogin(UserEvent event) {
        //me obtiene el objeto q lo genera
		User user = (User) event.getSource();
        //servlet es un controlador del lado del servidor que procesa requests y genera responses
        //no funcionan solos, necesitan un container como tomcat. son != al httprequest porq a esas las hace un cliente
