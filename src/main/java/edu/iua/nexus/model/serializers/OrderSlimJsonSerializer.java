...
public class OrderSlimJsonSerializer extends StdSerializer<Order> {

    public OrderSlimJsonSerializer(Class<?> t, boolean dummy) {
        super(t, dummy);
    }
    ...
    public void serializeOrderDetail(Order order, JsonGenerator jsonGenerator) throws IOException {
        ...
        for (Tank tanker : order.getTruck().getTanks()) {
            jsonGenerator.writeStartObject();
